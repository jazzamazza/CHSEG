...
class CHSEG_main:
    ...
    def setup(self, option):
        ...
        if (option == "1"): 
            ...
            self.pointCloud, self.pcd_with_truths = pc_loader.load_point_cloud_npy_from_file("Data\FINAL-PCD_raw_0.085.npy", "Data\FINAL-PCD-ALL_raw_0.085.npy") # setup point cloud with raw features 
        elif (option == "2"): 
